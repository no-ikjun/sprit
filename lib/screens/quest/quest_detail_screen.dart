...
class _QuestDetailScreenState extends State<QuestDetailScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      final value = await QuestService.findQuestByUuid(widget.questUuid);
      if (mounted) {
        setState(() {
          questInfo = value;
          isLoading = false;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyles.questDetailShortDescStyle,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyles.questDetailLongDescStyle,
                    ),
                  ],
                ),
              ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                          '퀘스트 시작',
                          style: TextStyles.questDetailScheduleStyle.copyWith(
                        ...
                        Text(
                          getFormattedDateTime(questInfo.startDate),
                          style: TextStyles.questDetailScheduleStyle,
                        ),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 6),
                        Text(
                          getFormattedDateTime(questInfo.endDate),
                          style: TextStyles.questDetailScheduleStyle,
                        ),
                      ],
                    ),
